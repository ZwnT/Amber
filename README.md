...
<p align="center">
  ...
  <a href="Readme/QQBOT_GUIDE.md">QQ机器人指南 (QQBot)</a>
</p>

## 💬 前言

“我深信，有意义的从不是那些冰冷的聊天软件和通讯协议，而是隐藏在对话框背后、由你和‘ta’共同谱写的一个个鲜活深刻的故事。
...
<p align="center">
  <img src="Readme/image/chatmain.png" alt="聊天界面" width="800px" />
  <img src="Readme/image/test_ProfileView1.png" alt="人格预览1" width="800px" />
  <img src="Readme/image/test_ProfileView2.png" alt="人格预览2" width="800px" />
  <br>
  <em>[图 1] 核心交互与人格档案预览：实装“艾尔 (Aero)”测试人格</em>
</p>

<p align="center">
  <img src="Readme/image/main_ui.png" alt="琥珀主界面" width="800px" />
  <br>
  <em>[图 2] 琥珀 (Amber) 核心内容：蒸馏后用户可以直接在聊天主页左侧联系人框选择聊天对象并开始聊天</em>
</p>

<p align="center">
  <img src="Readme/image/settings_center.png" alt="设置中心" width="800px" />
  <br>
  <em>[图 2] 全栈设置中心：物理整合 API 配置、内核引擎参数与个人 Profile</em>
</p>

<p align="center">
  <img src="Readme/image/distillation.tsx1.png" alt="意识重塑 Step 1" width="800px" />
  <img src="Readme/image/distillation.tsx2.png" alt="意识重塑 Step 2" width="800px" />
  <img src="Readme/image/distillation.tsx3.png" alt="意识重塑 Step 3" width="800px" />
  <img src="Readme/image/distillation.tsx4.png" alt="意识重塑 Step 4" width="800px" />
  <img src="Readme/image/distillation.tsx5.png" alt="意识重塑 Step 5" width="800px" />
  <br>
  <em>[图 3] 意识重塑 (Distillation)：从关系定义、主观印象、记忆材料到人格特征预览及情绪基准微调的全流程提炼过程</em>
</p>

<p align="center">
  <img src="Readme/image/relay_config.png" alt="QQ中继" width="800px" />
  <br>
...
在项目根目录或 `Amber/amber-engine` 目录下配置相应的 API Key 与 QQ 机器人凭证（可通过前端设置界面完成物理录入）。
